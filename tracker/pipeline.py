...
# Main controller for the complete offline tracking pipeline.
# Handles model loading, raw tracking, tracklet processing, global linking,
# identity reconstruction, and final cache generation.
class TrackingPipeline:
    # Initialize the pipeline configuration and model placeholders.
    ...
    # Verify that required input files and model paths exist before processing.
    ...
    # Load the standalone OSNet model for embeddings and initialize BoT-SORT.
    # BoT-SORT also loads its own ReID model internally using the same weights.
    ...
    # Execute the complete offline tracking workflow and return the final
    # frame-based tracking cache with global identities and locked classes.
    def run(self, detection_cache: dict, video_path: str | None = None, save_to: str | None = None) -> dict:
        ...
        # --- 1. Run raw BoT-SORT tracking over the video ---
        ...
        # --- 2. Convert raw IDs into tracklets and split ambiguous contacts ---
        ...
        # Remove very short tracklets that do not contain enough information
        # for reliable appearance and motion matching.
        ...
        # --- 3. Compute appearance and motion features for each tracklet ---
        ...
        # --- 4. Globally link fragmented tracklets using Hungarian matching ---
        ...
        # --- 5. Merge linked tracklets into final global identities ---
        ...
        # --- 6. Build final cache containing global IDs and ball detections ---
        ...
        # --- 7. Remove ghost tracks and lock final object classes ---
